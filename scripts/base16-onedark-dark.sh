...
# OneDark Dark scheme by olimorris (https://github.com/olimorris)
export BASE16_THEME=onedark-dark

color00="00/00/00" # Base 00 - Black
color01="ef/59/6f" # Base 08 - Red
color02="89/ca/78" # Base 0B - Green
color03="e5/c0/7b" # Base 0A - Yellow
color04="61/af/ef" # Base 0D - Blue
color05="d5/5f/de" # Base 0E - Magenta
color06="2b/ba/c5" # Base 0C - Cyan
color07="ab/b2/bf" # Base 05 - White
color08="43/48/52" # Base 03 - Bright Black
...
color18="1c/1f/24" # Base 01
color19="2c/31/3a" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 2c313a # selection color
