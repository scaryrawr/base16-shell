...
color15="e4/e4/e4" # Base 07 - Bright White
color16="a6/42/70" # Base 09
color17="6d/6d/6d" # Base 0F
color18="e4/e4/e4" # Base 01
color19="c0/c0/c0" # Base 02
color20="1c/1c/1c" # Base 04
color21="1c/1c/1c" # Base 06
color_foreground="23/23/23" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 232323 # foreground
  put_template_custom Ph dbdbdb # background
  put_template_custom Pi 232323 # bold color
  put_template_custom Pj c0c0c0 # selection color
  put_template_custom Pk 232323 # selected text color
  put_template_custom Pl 232323 # cursor
  put_template_custom Pm dbdbdb # cursor text
else
